...
def plot_stacked_histogram(sim_folder, data_folder, sim_samples, variables, out_path, bins=40, mass_window=(120, 130), signal_scale=100, include_2023=True):
    """
    ...
    var_config = {
        ...
        "nonRes_mjj_regressed": {"label": r"$m_{jj}^{reg}$ [GeV]", "bins": 30, "range": (70, 190), "log": True},
        "Res_mjj_regressed": {"label": r"Resonant $m_{jj}^{reg}$ [GeV]", "bins": 30, "range": (70, 190), "log": True},
        "Res_dijet_mass": {"label": r" Resonant $m_{jj}$ [GeV]", "bins": 30, "range": (70, 190), "log": True},
...
def plot_stacked_histogram_parquet(sim_folder, data_folder, sim_samples, variables, out_path, bins=40, mass_window=(120, 130), signal_scale=100):
    """
    Load data first, then loop over variables to plot stacked histograms with MC and Data, including ratio plots.
