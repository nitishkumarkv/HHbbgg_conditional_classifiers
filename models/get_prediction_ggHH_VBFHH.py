...
if __name__ == "__main__":
    ...
    # ggHH model
    parser.add_argument('--ggHH_model_folder', required=True)
    ...
    # VBFHH model
    parser.add_argument('--VBFHH_model', required=True)
    ...
    if args.MVA_choice != "ggHH_only":
        ...
        model_VBFHH = tf.keras.models.load_model(args.VBFHH_model)
