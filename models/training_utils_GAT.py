...
# Paths
input_path = "../data/gnn_inputs_20241203"
path_to_checkpoint = "train_gnn_inputs_20241203/training_500/"
...
save_checkpoint(epoch, model, optimizer, scheduler, 
                ...
                best_weights, best_loss, f"{path_to_checkpoint}/GAT.pth")
...
np.save(f"{path_to_checkpoint}/weights_train.npy", weights_train_np)

np.save(f"{path_to_checkpoint}/y_pred_val.npy", y_pred_val_np)
np.save(f"{path_to_checkpoint}/y_val.npy", y_val_np)
np.save(f"{path_to_checkpoint}/weights_val.npy", weights_val_np)
...
with open(f"{path_to_checkpoint}/hyperparameters.json", "w") as f:
