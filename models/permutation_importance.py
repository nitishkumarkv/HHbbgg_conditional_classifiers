...
if __name__ == "__main__":
    ...
    #corrcoeff_matrix = get_corrcoef(X_train, class_weights_for_training)
    #plot_corrcoef(corrcoeff_matrix, input_vars, f'{input_path}/corrcoef_matrix_inclusive_class_weights_for_training')
    ...
    # Compute permutation importance for weighted accuracy
    #print("Computing permutation importance using weighted accuracy...")
    #result_accuracy = permutation_importance(
    #    model_wrapper, X_val, y_val, n_repeats=5,
    #    scoring=lambda estimator, X, y: weighted_accuracy(y, estimator.predict(X), class_weights_for_val),
    #    random_state=42
    #)
    ...
    if not os.path.exists(f'{path_to_importance_plots}/permutation_importances.pkl'):
        ...
        # Extract importances
        #importances_accuracy = result_accuracy.importances_mean
        #std_accuracy = result_accuracy.importances_std
    ...
    # Plot the feature importances for weighted accuracy
    #plt.figure(figsize=(12, 8))
    #plt.barh(df_importances['Feature'], df_importances['Accuracy_importance'], xerr=df_importances['Accuracy_std'])
    #plt.gca().invert_yaxis()
    #plt.tight_layout()
    #plt.savefig(f'{path_to_importance_plots}/permutation_importance_accuracy.png', dpi=300)
    ...
    plt.xlabel('Increase in cross-entropy loss')
    plt.tight_layout()
