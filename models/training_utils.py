...
def train(input_path):
    ...
    # Paths
    input_path = "../data/inputs_for_MLP_202411226/"
    best_params_path = 'random_search_inputs_for_MLP_202411226/best_params.json'
    path_to_checkpoint = "train_inputs_for_MLP_202411226/after_random_search_best1/"
