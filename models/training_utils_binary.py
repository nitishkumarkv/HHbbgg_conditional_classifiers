...
# Paths
input_path = "../data/inputs_for_binary_MLP_20250121/"
best_params_path = 'random_search_inputs_for_binary_MLP_20250121/best_params.json'
path_to_checkpoint = "inputs_for_binary_MLP_20250121/best/"
...
# For demonstration, you can specify best_params directly
...
#best_params = {'num_layers': 5, 'num_nodes': 1024, 'act_fn_name': 'ELU', 'lr': 1.5724146349559428e-05, 'weight_decay': 6.0166737098855164e-05, 'dropout_prob': 0.4}
