...
def plot_stacked_histogram_from_events(
    ...
    label_map = {
        ...
        "GluGlutoHHto2B2G_kl_1p00_kt_1p00_c2_3p00": r"ggHH $c_{2}$=3",
        "GluGlutoHHto2B2G_kl_1p00_kt_1p00_c2_0p35": r"ggHH $c_{2}$=0.35",
        "GluGlutoHHto2B2G_kl_0p00_kt_1p00_c2_1p00": r"ggHH $\kappa_\lambda$=0, $c_{2}$=1",
        "GluGlutoHHto2B2G_kl_1p00_kt_1p00_c2_0p10": r"ggHH $c_{2}$=0.1",
        "GluGlutoHHto2B2G_kl_1p00_kt_1p00_c2_m2p00": r"ggHH $c_{2}$=-2",
        "GluGlutoHHto2B2G_kl_m20p00_kt_1p00_c2_2p24": r"ggHH $\kappa_\lambda$=-20, $c_{2}$=2.24",
...
class SRPlotter:
    ...
    def plot_SR(self, variables, out_dir, plot_func, signal_scale=1000):
        ...
        self.sample_order = ["VBFHToGG_M_125", "VHtoGG_M_125", "ttHtoGG_M_125", "GluGluHToGG_M_125", "GluGlutoHHto2B2G_kl_1p00_kt_1p00_c2_0p00", "GluGlutoHHto2B2G_kl_0p00_kt_1p00_c2_0p00", "GluGlutoHHto2B2G_kl_2p45_kt_1p00_c2_0p00", "GluGlutoHHto2B2G_kl_5p00_kt_1p00_c2_0p00", "GluGlutoHHto2B2G_kl_1p00_kt_1p00_c2_3p00",
                             "GluGlutoHHto2B2G_kl_1p00_kt_1p00_c2_0p35", "GluGlutoHHto2B2G_kl_0p00_kt_1p00_c2_1p00", "GluGlutoHHto2B2G_kl_1p00_kt_1p00_c2_0p10", "GluGlutoHHto2B2G_kl_1p00_kt_1p00_c2_m2p00", "GluGlutoHHto2B2G_kl_m20p00_kt_1p00_c2_2p24", 
                             "TTGG", "GGJets", "DDQCDGJET"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out-dir", default="SR_plots/MC_only")
    ...
    plotter.plot_SR(
        variables=variables,
        out_dir=f"{args.base_path}/{args.out_dir}",
